  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      <div style={{ marginRight: '10px' }}>
        ...
        >
          {loading && loadingButton === '/forgottens' ? <CircularProgress size={24} color="inherit" /> : 'Go to Forgottens'}
        </Button>
      </div>
      <div>
        <Button
        ...
        >
          {loading && loadingButton === '/holdback' ? <CircularProgress size={24} color="inherit" /> : 'Go to Holdback'}
        </Button>
      </div>
    </div>
  );
