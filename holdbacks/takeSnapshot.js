...
const headers = { 'x-api-key': '1a47be0a958449c58bc53e9e5a8988e5' }
...
async function main() {
  ...
  const jsonData = JSON.stringify(_.orderBy(holdbackMiners, 'id', 'asc'), null, 2)

  await fs.writeFile('holdbacksList.json', jsonData)
}
